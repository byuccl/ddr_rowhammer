...
5. A UART timeout occured. The ttyUSB device was closed and reopened, and a timeout reoccured. A UART bone reset was issued, and the BIST restarted successfully.
...
8. A UART timeout occured, and the BIST did not recover after reopening the ttyUSB device nor after issuing a UART bone reset. The Netbooter repowered the board, and the JCM was reconfigured.
