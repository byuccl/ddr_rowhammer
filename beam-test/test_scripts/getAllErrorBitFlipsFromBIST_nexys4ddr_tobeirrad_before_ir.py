...
LOG_FILE_NONIR_STRINGS = [
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_586.log", 586, 0, ONES_REF_STR, 0, 33, ZEROS_REF_STR, 1),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_1172.log", 1172, 0, ONES_REF_STR, 2, 33, ZEROS_REF_STR, 3),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_2344.log", 2344, 0, ONES_REF_STR, 4, 33, ZEROS_REF_STR, 5), 
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_4688.log", 4688, 0, ONES_REF_STR, 6, 33, ZEROS_REF_STR, 7),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_9376.log", 9376, 0, ONES_REF_STR, 8, 33, ZEROS_REF_STR, 9),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_18752.log", 18752, 0, ONES_REF_STR, 10, 39, ZEROS_REF_STR, 11),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_37504.log", 37504, 0, ONES_REF_STR, 12, 131, ZEROS_REF_STR, 13),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_75008.log", 75008, 0, ONES_REF_STR, 14, 1427, ZEROS_REF_STR, 15),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_150016.log", 150016, 0, ONES_REF_STR, 16, 16026, ZEROS_REF_STR, 17),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_300032.log", 300032, 0, ONES_REF_STR, 18, 142670, ZEROS_REF_STR, 19),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_600064.log", 600064, 0, ONES_REF_STR, 20, 911551, ZEROS_REF_STR, 21),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_1200128.log", 1200128, 0, ONES_REF_STR, 22, 3602326, ZEROS_REF_STR, 23),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_2400256.log", 2400256, 0, ONES_REF_STR, 24, 5670954, ZEROS_REF_STR, 25),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_4800512.log", 4800512, 0, ONES_REF_STR, 26, 6702217, ZEROS_REF_STR, 27),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_9601024.log", 9601024, 0, ONES_REF_STR, 28, 6961860, ZEROS_REF_STR, 29),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_19202048.log", 19202048, 0, ONES_REF_STR, 30, 7080188, ZEROS_REF_STR, 31),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_BIST_separate_files/nexys4ddr_tobeirrad_nonir_bist_five_min__UART_refresh_rate_38404096.log", 38404096, 0, ONES_REF_STR, 32, 7335515, ZEROS_REF_STR, 33),
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_tobeirrad_nonir_bist_ones_tk2_UART.log", 0, 0, ONES_REF_STR, 34), # Ones
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_tobeirrad_nonir_bist_zeros_UART.log", 0, 0, ZEROS_REF_STR, 35), # Zeros
    ("/media/rickstr/KINGSTON/row_hammer_research/TBA_new_radiation_test/Experiment_Data/nexys4ddr/nexys4ddr_tobeirrad_before_irradiation/bist_data/nexys4ddr_tobeirrad_nonir_restofbits_UART_refresh_rate_0.log", 0, 0, ONES_REF_STR, 36, 2081, ZEROS_REF_STR, 37),
]
        ...
        with open(file_tuple[FILE_NAME_INDEX]) as openedFile:
            for num, line in enumerate(openedFile, 1):
                ...
                if (re.search(REGEX_ERROR_STR, line) != None):
                    ...
                    # print(timeString)
                    bankString = timeString[4:5]  # Address is 7 digits including four extra bits to the left, row address is bits 0 - 12, bank is bits 13 - 15 so get
                                                # the letters corresponding to bits 13 - 16
                    # print(bankString)
                    ...
                    bankBinaryStr = bankBinaryStr[:2] + bankBinaryStr[2:5] # Take out bit 4, leave 'Ob' at the beginning
                    # print(bankBinaryStr)
                    # if bankBinaryStr == '0b011':
                    ...
                    try:
                        ...
                        if refresh_bank_total_bits[test_num] % 64 != 0:
                            print("ERROR: Bank total bit flips not divisible by 64")
                            print("Len of dataval: ", len(dataval), ", dataval: ", dataval, ", Line: ", line)
