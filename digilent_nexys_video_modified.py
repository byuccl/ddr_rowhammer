...
# MODIFIED: Added these from soc.py
...
class BaseSoC(SoCCore):
    def __init__(
        ...
        **kwargs
        ...
        # SoCCore ----------------------------------------------------------------------------------
        SoCCore.__init__(
            self, platform, sys_clk_freq, ident="LiteX SoC on Nexys Video", **kwargs
        )
        ...
        if with_sata:
            ...
            self.submodules.sata_phy = LiteSATAPHY(
                platform.device,
                refclk=None
                if not with_sata_pll_refclk
                else self.crg.cd_sata_refclk.clk,
    ...
    # Add SDRAM ------------------------------------------------------------------------------------
    # MODIFIED: Overriding default add_sdram to customize.
    def add_sdram(
        self,
        name="sdram",
        phy=None,
        ...
        **kwargs
        ...
        # MODIFIED: Add extra port for testing.
        # Giving it a strange name that hopefully survives name mangling.
        flerp = self.sdram.crossbar.get_port()
