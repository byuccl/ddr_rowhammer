...
* NexysVideo:
  ...
  * completed rows 0 - 12183 of bank #0 (BYU-Artix7-007) (currently running)
    * 7 files = {1.4 GB, 9.7 MB, 977.1 MB, 191.8 MB, 109.3 MB, 106.6 MB, 993.0 MB}
    * Compressed all together: 232.7 MB
* AntMicro:
