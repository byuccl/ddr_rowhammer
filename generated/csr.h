...
/* sdram_checker */
#define CSR_SDRAM_CHECKER_BASE (CSR_BASE + 0x2800L)
#define CSR_SDRAM_CHECKER_RESET_ADDR (CSR_BASE + 0x2800L)
...
#define CSR_SDRAM_CHECKER_START_ADDR (CSR_BASE + 0x2804L)
...
#define CSR_SDRAM_CHECKER_DONE_ADDR (CSR_BASE + 0x2808L)
...
#define CSR_SDRAM_CHECKER_BASE_ADDR (CSR_BASE + 0x280cL)
#define CSR_SDRAM_CHECKER_BASE_SIZE 1
static inline uint32_t sdram_checker_base_read(void) {
	return csr_read_simple((CSR_BASE + 0x280cL));
}
static inline void sdram_checker_base_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x280cL));
}
#define CSR_SDRAM_CHECKER_END_ADDR (CSR_BASE + 0x2810L)
#define CSR_SDRAM_CHECKER_END_SIZE 1
static inline uint32_t sdram_checker_end_read(void) {
	return csr_read_simple((CSR_BASE + 0x2810L));
}
static inline void sdram_checker_end_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2810L));
}
#define CSR_SDRAM_CHECKER_LENGTH_ADDR (CSR_BASE + 0x2814L)
#define CSR_SDRAM_CHECKER_LENGTH_SIZE 1
static inline uint32_t sdram_checker_length_read(void) {
	return csr_read_simple((CSR_BASE + 0x2814L));
}
static inline void sdram_checker_length_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2814L));
}
#define CSR_SDRAM_CHECKER_RANDOM_ADDR (CSR_BASE + 0x2818L)
...
#define CSR_SDRAM_CHECKER_TICKS_ADDR (CSR_BASE + 0x281cL)
...
#define CSR_SDRAM_CHECKER_ERRORS_ADDR (CSR_BASE + 0x2820L)
...
/* sdram_generator */
#define CSR_SDRAM_GENERATOR_BASE (CSR_BASE + 0x3000L)
#define CSR_SDRAM_GENERATOR_RESET_ADDR (CSR_BASE + 0x3000L)
...
#define CSR_SDRAM_GENERATOR_START_ADDR (CSR_BASE + 0x3004L)
...
#define CSR_SDRAM_GENERATOR_DONE_ADDR (CSR_BASE + 0x3008L)
...
#define CSR_SDRAM_GENERATOR_BASE_ADDR (CSR_BASE + 0x300cL)
#define CSR_SDRAM_GENERATOR_BASE_SIZE 1
static inline uint32_t sdram_generator_base_read(void) {
	return csr_read_simple((CSR_BASE + 0x300cL));
}
static inline void sdram_generator_base_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x300cL));
}
#define CSR_SDRAM_GENERATOR_END_ADDR (CSR_BASE + 0x3010L)
#define CSR_SDRAM_GENERATOR_END_SIZE 1
static inline uint32_t sdram_generator_end_read(void) {
	return csr_read_simple((CSR_BASE + 0x3010L));
}
static inline void sdram_generator_end_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3010L));
}
#define CSR_SDRAM_GENERATOR_LENGTH_ADDR (CSR_BASE + 0x3014L)
#define CSR_SDRAM_GENERATOR_LENGTH_SIZE 1
static inline uint32_t sdram_generator_length_read(void) {
	return csr_read_simple((CSR_BASE + 0x3014L));
}
static inline void sdram_generator_length_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3014L));
}
#define CSR_SDRAM_GENERATOR_RANDOM_ADDR (CSR_BASE + 0x3018L)
...
#define CSR_SDRAM_GENERATOR_TICKS_ADDR (CSR_BASE + 0x301cL)
